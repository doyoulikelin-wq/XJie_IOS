...
- 截至 2026-07-14，本轮最终修改后的快速门禁为绿，但最终 working-tree `impacted` 仍待从头执行；早期 tree 的完整绿色结果已经因终审新增网络、系统、PBX/Release 和 whole-IPA 不变量而失效，不能提前写成最终全量通过。
